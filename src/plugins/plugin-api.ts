...
import { LayerMetrics, PerformanceMetrics, Definition, Reference, Completion } from '../core/types.js';
...
export interface CoreEventHandler {
  (event: CoreEvent): void | Promise<void>;
}
...
export interface EndpointHandler {
  (request: ProtocolRequest, response: ProtocolResponse): Promise<void>;
}
...
export interface FileWatchCallback {
  (event: 'add' | 'change' | 'unlink', path: string): void;
}
