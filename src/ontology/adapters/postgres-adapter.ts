    ...
    async saveConcept(concept: Concept): Promise<void> {
        ...
        try {
         ...
         ON CONFLICT (id) DO UPDATE SET canonical_name = EXCLUDED.canonical_name,
           ...
           updated_at = NOW()`,
                [concept.id, concept.canonicalName, concept.confidence, JSON.stringify(this.serializeConcept(concept))]
            );
           ...
           VALUES ($1,$2,$3,$4,$5,$6,$7)`,
                    [concept.id, ev.timestamp.toISOString(), ev.type, ev.from, ev.to, ev.reason || null, ev.confidence]
                );
            }
